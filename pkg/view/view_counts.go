...
// NewCountService creates a new View Count service backed by a Versionary Table for the specified environment.
...
// NewMockService creates a new View Count service backed by an in-memory table for testing purposes.
