...
// NewViewTable instantiates a new DynamoDB View table.
func NewViewTable(dbClient *dynamodb.Client, env string) v.Table[View] {
	if env == "" {
		env = "dev"
	}
	return v.Table[View]{
...
// NewViewMemTable creates an in-memory View table for testing purposes.
func NewViewMemTable(table v.Table[View]) v.MemTable[View] {
...
// ViewService is used to manage a View database.
...
func (s ViewService) Create(ctx context.Context, view View) (View, []string, error) {
	t := tuid.NewID()
	at, _ := t.Time()
	view.ID = t.String()
	view.CreatedAt = at
...
func (s ViewService) ReadViewIDs(ctx context.Context, reverse bool, limit int, offset string) ([]string, error) {
...
func (s ViewService) ReadViews(ctx context.Context, reverse bool, limit int, offset string) []View {
...
func (s ViewService) ReadDates(ctx context.Context, reverse bool, limit int, offset string) ([]string, error) {
...
func (s ViewService) ReadAllDates(ctx context.Context) ([]string, error) {
...
func (s ViewService) ReadViewsByDate(ctx context.Context, date string, reverse bool, limit int, offset string) ([]View, error) {
...
// The offset is the ID of the last View returned in a previous request.
func (s ViewService) ReadViewsByDateAsJSON(ctx context.Context, date string, reverse bool, limit int, offset string) ([]byte, error) {
...
func (s ViewService) ReadAllViewsByDate(ctx context.Context, date string) ([]View, error) {
...
func (s ViewService) ReadAllViewsByDateAsJSON(ctx context.Context, date string) ([]byte, error) {
...
func (s ViewService) CountViewsByDate(ctx context.Context, date string) (Count, error) {
	c := Count{}
...
func (s ViewService) ReadDeviceIDs(ctx context.Context, reverse bool, limit int, offset string) ([]string, error) {
...
func (s ViewService) ReadAllDeviceIDs(ctx context.Context) ([]string, error) {
...
// The offset is the ID of the last View returned in a previous request.
func (s ViewService) ReadViewsByDeviceID(ctx context.Context, deviceID string, reverse bool, limit int, offset string) ([]View, error) {
...
// The offset is the ID of the last View returned in a previous request.
func (s ViewService) ReadViewsByDeviceIDAsJSON(ctx context.Context, deviceID string, reverse bool, limit int, offset string) ([]byte, error) {
...
func (s ViewService) ReadAllViewsByDeviceID(ctx context.Context, deviceID string) ([]View, error) {
...
func (s ViewService) ReadAllViewsByDeviceIDAsJSON(ctx context.Context, deviceID string) ([]byte, error) {
